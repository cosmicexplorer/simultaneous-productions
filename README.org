...
2. [-] graphviz for every intermediate graph in grammar processing! [2/3]
   ...
   3. [ ] ~ParseableGrammar~ [0/2]
      - [ ] first make parsing understand stack cycles!!!
      - [ ] then figure out how to represent stack cycles in graphvis!
3. [-] text-based grammar input format (for generating test cases)! [4/5]
   ...
   5. [-] extend the text grammar format to allow regex operators! [2/5]
