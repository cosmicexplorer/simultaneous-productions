...
pub mod parsing {
  ...
  pub struct FlattenedSpanInfo {
    left_state: LoweredState,
    right_state: LoweredState,
  ...
  impl ParseableGrammar {
    ...
    pub fn new<Tok: PartialEq+Eq+Hash+Copy+Clone>(grammar: &PreprocessedGrammar<Tok>) -> Self {
