...
class EnsimeGen(ModifiedExportTaskBase, JvmToolTaskMixin):
  ...
  def execute(self):
    ...
    with temporary_dir() as tmpdir:
      ...
      ensime_gen_target = self.context.build_graph.resolve_address(ensime_gen_target_address)
      ...
      scala_compiler_jars = [
        os.path.join(get_buildroot(), cp.path) for cp in
        self._scala_platform.compiler_classpath_entries(
