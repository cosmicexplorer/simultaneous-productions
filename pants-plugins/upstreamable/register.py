...
from upstreamable.targets.custom_scrooge_dependencies import \
...
from upstreamable.targets.pants_jvm_binary_subproject import PantsJvmBinarySubproject
from upstreamable.targets.sbt_dist import SbtDist
from upstreamable.tasks.bootstrap_coursier import BootstrapCoursier
...
from upstreamable.tasks.publish_local_sbt_distributions import \
